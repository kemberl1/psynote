-- ============================================================================
-- История: версии дневников и отзывов, отзыв переживает удаление дневника.
--
-- Перегенерация больше не затирает текст, на который врач оставил отзыв;
-- правка отзыва сохраняет прежний комментарий. Те же DDL gateway выполняет
-- при старте (store.EnsureHistorySchema) — держать в синхроне.
-- ============================================================================
