...
Форматирование DOCX/PDF соответствует корпусному сборнику (эталонный DOCX в `Документы/02_корпус/сборник_дневников_ИБ/`, только локально): Calibri 11pt, поля 2,5 см, выравнивание по ширине, жирные секции.
