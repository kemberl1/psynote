...
_DAILY_FREETEXT_QUESTIONS: dict[str, str] = {
    "productive_symptoms_detail": "Характер психопродуктивной симптоматики",
    "behavior_detail": "Характер нарушений режима",
    "adverse_detail": "Нежелательные явления",
    "complaints_detail": "Жалобы",
    "events_detail": "События дня",
}
...
_EXAM_FREETEXT_QUESTIONS: dict[str, str] = {
    ...
    "interventions_detail": "Выполненные вмешательства",
}
