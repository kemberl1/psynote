...
_DAILY_QUESTIONS: dict[str, dict] = {
    "patient_sex": {
        ...
        "options": {
            "male": (
                "Пациент — мальчик. Согласуй грамматический род: он, упорядочен, "
                "беспокоен, получал замечания."
            ),
            "female": (
                "Пациент — девочка. Согласуй грамматический род: она, упорядочена, "
                "беспокойна, получала замечания."
            ),
        },
    },
    "dynamics": {
    ...
    "anamnesis_life": {
        "label": "Анамнез жизни (дополнения)",
        "options": {
            "no_additions": "Анамнез жизни: без дополнений.",
            "present": "Имеются дополнения к анамнезу жизни.",
        },
    },
    "events": {
        "label": "События дня",
    ...
    "treatment_plan": {
        "label": "План лечения",
        "options": {
            "no_change": "План лечения: без дополнений.",
            "adjusted": ("План лечения: в связи с изменением состояния "
                         "проведена корректировка."),
        },
    },
    "prescriptions": {
        "label": "Назначения",
        "options": {
            "see_list": "Назначения: см. лист назначений.",
            "no_change": "Назначения: см. лист назначений.",
        },
    },
    "additional_info": {
        "label": "Дополнительные сведения о заболевании",
        "options": {
            "none": "Дополнительные сведения о заболевании: нет.",
            "present": "Имеются дополнительные сведения о заболевании.",
        },
    },
    "diagnosis_justification": {
        "label": "Обоснование диагноза",
        "options": {
            "not_required": "Обоснование диагноза: не требуется.",
            "present": "Обоснование диагноза имеется.",
        },
    },
}
...
_DAILY_FREETEXT_QUESTIONS: dict[str, str] = {
    ...
    "anamnesis_detail": "Дополнения к анамнезу заболевания",
    "anamnesis_life_detail": "Дополнения к анамнезу жизни",
    "events_detail": "Детали событий дня",
    "exam_plan_detail": "План обследования (причина корректировки)",
    "treatment_plan_detail": "План лечения (причина корректировки)",
    "additional_info_detail": "Дополнительные сведения о заболевании",
    "diagnosis_justification_detail": "Обоснование диагноза",
...
_EXAM_QUESTIONS: dict[str, dict] = {
    ...
    "thinking": {
        ...
        "options": {
            ...
            "visual_action": "Мышление наглядно-действенное.",
            "visual_imagery": "Мышление наглядно-образное.",
    ...
    "intellect": {
        ...
        "options": {
            ...
            "mild_id": ("Интеллектуально представляется сниженным до уровня "
                        "лёгкой умственной отсталости, запас сведений неравномерен. "
                        "На вопросы из школьной программы отвечает выборочно."),
            "moderate_id": ("Интеллектуально-мнестически представляется на уровне "
                            "умеренной умственной отсталости. Критика отсутствует. "
                            "Эмоциональные реакции недифференцированные, лабильные. "
                            "Волевой контроль резко снижен. Мышление наглядно-действенное "
                            "или сугубо конкретное."),
            "severe_id": ("Интеллектуально-мнестически представляется на уровне "
                          "тяжёлой умственной отсталости. Критика отсутствует. "
                          "Эмоциональные реакции недифференцированные. "
                          "Волевой контроль отсутствует. Мышление наглядно-действенное."),
