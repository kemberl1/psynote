	...
	return []Question{
		...
		},
		{
			...
			Options: []Option{
				...
				{Value: "staff_remarks", Label: "замечания персонала (без причины)", Prompt: "со слов персонала получал замечания, на них реагировал непродолжительно"},
			},
		},
		...
		},
		{
			...
			Help: "Строка бланка под диагнозом. В понедельник после выходных (не первые 3 дня) — формула про дежурный персонал за сб–вс. Отдельные дневники за субботу и воскресенье не пишем.",
			Options: []Option{
		...
		},
		{
			...
			Required: false, AllowCustom: true, Group: grpEvents,
			Help: "В понедельник после выходных (не первые 3 дня госпитализации): формула про дежурный персонал за сб–вс и кратко что было. Отдельные дневники за субботу и воскресенье не пишем.",
		},
		{
	...
	return []Question{
		...
		},
		{
			...
			Options: []Option{
				...
				{Value: "visual_action", Label: "наглядно-действенное", Prompt: "Мышление наглядно-действенное."},
				{Value: "visual_imagery", Label: "наглядно-образное", Prompt: "Мышление наглядно-образное."},
		...
		},
		{
			...
			Options: []Option{
				...
				{Value: "mild_id", Label: "лёгкая умственная отсталость", Prompt: "Интеллектуально представляется сниженным до уровня лёгкой умственной отсталости, запас сведений неравномерен. На вопросы из школьной программы отвечает выборочно."},
				{Value: "moderate_id", Label: "умеренная умственная отсталость", Prompt: "Интеллектуально-мнестически представляется на уровне умеренной умственной отсталости. Критика отсутствует. Эмоциональные реакции недифференцированные, лабильные. Волевой контроль резко снижен. Мышление наглядно-действенное или сугубо конкретное."},
				{Value: "severe_id", Label: "тяжёлая умственная отсталость", Prompt: "Интеллектуально-мнестически представляется на уровне тяжёлой умственной отсталости. Критика отсутствует. Эмоциональные реакции недифференцированные. Волевой контроль отсутствует. Мышление наглядно-действенное."},
